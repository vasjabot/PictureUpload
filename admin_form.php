...
class CAdminForm extends CAdminTabControl
{
	...
	function SetFieldsValues($bVarsFromForm, $db_record, $default_values)
	{
		foreach($default_values as $key=>$value)
			...
			//$this->SetFieldValue('666', '666', '666', '666');
	}
...
<script type="text/javascript">'.$this->publicObject.'.SetButtons(['.$this->publicObject.'.btnSave, '.$this->publicObject.'.btnCancel]);
alert("BUTTON");
</script>
';
			}
